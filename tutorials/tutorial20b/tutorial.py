# Dementev blowdown experiment with pipe choking
...
tank = circuit1.add_tptank("node1", elevation=0.0, geom=("vertcyl", 0.309, 2.13))
circuit1.add_node("node2", elevation=0.0)
...
bc1 = circuit1.add_BC("bc1", "node1", "P", 123.0e5, trans=False)
bc2 = circuit1.add_BC("bc2", "node1", "T", 535.0, trans=False)
bc3 = circuit1.add_BC("bc3", "node2", "P", 1.0e5)
...
settings.conv_crit_flow = 1.0e-7
settings.conv_crit_temp_trans = 1.0e-7
settings.conv_crit_temp_SS = 1.0e-7
